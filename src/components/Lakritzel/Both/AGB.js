...
function AGB() {
  return (
    <>
      <Wrapper>
        <Text>
          Allgemeine Geschäftsbedingungen der Firma Lakritzel
          <br /> <br />
          §1 Geltung gegenüber Unternehmern und Begriffsdefinitionen (1) Die
          ...
          13 BGB).
          <br /> <br />
          §2 Zustandekommen eines Vertrages, Speicherung des Vertragstextes (1)
          Die folgenden Regelungen über den Vertragsabschluss gelten für
          Bestellungen über unseren Internetshop http://www.lakritzel.com .
          <br /> <br />
          ...
          enthaltenen „Zurück“-Taste nach Kontrolle seiner Angaben wieder zu der
          Internetseite gelangen, auf der die Angaben des Kunden erfasst werden
