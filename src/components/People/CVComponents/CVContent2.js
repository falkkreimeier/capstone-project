...
function CVContent2() {
  return (
    <>
      ...
      <Text>Aug 2014 - Okt 2016</Text>
      <List>
        <ListItem>
          Kampagnenentwicklung Print/Funk/Social Media für Marken, wie: CITROEN,
          CAR2GO und die DEUTSCHE BANK
        </ListItem>
        <ListItem>
